...
class IPhone11ProX117 extends StatelessWidget {
  const IPhone11ProX117({Key key}) : super(key: key);
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(
                                        ...
                                        height: 42.0,
                                        child: Text(
                                          'Вам понравилось наше приложение?',
                                          style: TextStyle(
                                            fontFamily: 'SF Pro Display',
                                            fontSize: 18.0,
                                      ...
                                      Align(
                                        ...
                                        child: SizedBox(
                                          ...
                                          height: 38.0,
                                          child: Text(
                                            'Тогда уделите нам минуту внимания \nи оцените его в магазине приложений',
                                            style: TextStyle(
                                              fontFamily: 'SF Pro Display',
                                              fontSize: 16.0,
                                              color: const Color(0xFFBABABA),
